...
Apart from these 'not so obvious' reasons, why you should care about installing Protect My Browsers is because it blocks ads across all your apps unlike browser extensions which only work in a browser.   
